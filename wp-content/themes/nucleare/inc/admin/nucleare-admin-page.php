		...
		<div class="cresta-theme-info">
			...
			<div class="welcome-description-wrap">
				...
				<p class="cresta-actions">
					<a href="<?php echo esc_url( 'http://crestaproject.com/downloads/nucleare/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'nucleare' ); ?></a>
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					...
					<div class="col">
						...
						<p><a target="_blank" href="<?php echo esc_url( 'http://crestaproject.com/downloads/nucleare/' ); ?>" class="button button-secondary"><?php esc_html_e( 'Info about PRO version', 'nucleare' ); ?></a></p>
					</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="btn-wrapper">
							...
							<a href="<?php echo esc_url( apply_filters( 'nucleare_pro_theme_url', 'http://crestaproject.com/downloads/nucleare/' ) ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'More Information', 'nucleare' ); ?></a>
						</td>
					</tr>
				</tbody>
			</table>
